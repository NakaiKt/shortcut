...
export const commands: Command[] = [
  ...
  },
  {
    ...
    category: 'basic',
    name: 'ダミーファイル作成',
    description: '指定したサイズと拡張子でダミーファイルを作成します。値を手入力してサイズを指定できます',
    windowsCommand: 'fsutil file createnew {ファイル名}.{拡張子} {値を入力}',
    macCommand: 'mkfile {値を入力}{単位} {ファイル名}.{拡張子}',
    options: [
      {
        id: 'unit-kb',
        windows: '* 1024',
        mac: 'k',
        description: '単位: KB（例: 10KB → Windows: 10 * 1024 = 10240バイト / Mac: 10k）',
      },
      {
        id: 'unit-mb',
        windows: '* 1048576',
        mac: 'm',
        description: '単位: MB（例: 10MB → Windows: 10 * 1048576 = 10485760バイト / Mac: 10m）',
      },
      {
        id: 'unit-gb',
        windows: '* 1073741824',
        mac: 'g',
        description: '単位: GB（例: 1GB → Windows: 1 * 1073741824 = 1073741824バイト / Mac: 1g）',
      },
      {
        id: 'ext-txt',
        windows: 'txt',
        mac: 'txt',
        description: '拡張子: .txt (テキストファイル)',
      },
      {
        id: 'ext-log',
        windows: 'log',
        mac: 'log',
        description: '拡張子: .log (ログファイル)',
      },
      {
        id: 'ext-csv',
        windows: 'csv',
        mac: 'csv',
        description: '拡張子: .csv (CSVファイル)',
      },
      {
        id: 'ext-json',
        windows: 'json',
        mac: 'json',
        description: '拡張子: .json (JSONファイル)',
      },
      {
        id: 'ext-xml',
        windows: 'xml',
        mac: 'xml',
        description: '拡張子: .xml (XMLファイル)',
      },
      {
        id: 'ext-dat',
        windows: 'dat',
        mac: 'dat',
        description: '拡張子: .dat (データファイル)',
      },
    ],
  },
];
