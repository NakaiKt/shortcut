...
export const commands: Command[] = [
  ...
  },
  {
    ...
    category: 'basic',
    name: 'ダミーファイル作成',
    description: '指定したサイズと拡張子でダミーファイルを作成します',
    windowsCommand: 'fsutil file createnew {ファイル名}.{拡張子} {バイトサイズ}',
    macCommand: 'mkfile {サイズ} {ファイル名}.{拡張子}',
    options: [
      {
        id: 'size-1kb',
        windows: '1024',
      ...
      },
      {
        ...
        windows: '10240',
        mac: '10k',
        description: 'サイズ: 10KB',
      },
      {
        id: 'size-100kb',
        windows: '102400',
        mac: '100k',
        description: 'サイズ: 100KB',
      },
      {
        id: 'size-1mb',
        windows: '1048576',
      ...
      },
      {
        ...
        windows: '10485760',
        mac: '10m',
        description: 'サイズ: 10MB',
      },
      {
        id: 'size-100mb',
        windows: '104857600',
        mac: '100m',
        description: 'サイズ: 100MB',
      },
      {
        id: 'ext-txt',
        windows: 'txt',
